...
public class ModeleView extends JFrame {
    ...
    public ModeleView() {
        ...
        addButton.addActionListener(e -> {
            ...
            List<String> marques = controller.getAllMarques(); // Méthode à implémenter dans le contrôleur
        
            JComboBox<String> marqueBox = new JComboBox<>(marques.toArray(new String[0]));
            ...
            Object[] message = {
                    "Nom du modèle :", nomField,
                    "Nom de la marque associée :", marqueBox
            };
            ...
            if (option == JOptionPane.OK_OPTION) {
                try {
                    ...
                    String nomMarque = (String) marqueBox.getSelectedItem(); // Utiliser le nom de la marque
